""" faulty example for getting activities from multiple jsons.

develop further for optimisation study:
- fix to extract metastables as well
- use to extract lots of fispact activities from lots of unfolded spectrum sims
