...
data_file_name = 'interspec_data_2.json'
...
irradiation_end = datetime(2025,9,23, 14,54,10)
...
results_name = 'e_results_2'

# run get_activities
get_activities.calculate_activities(irrad_time,results_name,'../../data/XCOM_new',which_isotopes)
