...
plotname = 'root_unfolded_250625'

# FLUX NORMALISATION for C results - calculated using be7 calcs from the xs_calculator program
flux_norm_mean = 0.8733 #mcnp/be7/p-li= 0.7(0.026985 rescale) or 0.801787(0.0309 rescale), 0.8733 for initial unfolded175/be7/p-li fispact sims 
