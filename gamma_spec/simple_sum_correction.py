...
eu152_38cm = { 121.78:16.16, 244.7:3.262, 344.28:8.735, 443.96:0.7764 , 778.90:2.189, 867.38:0.659, 964.08:2.111, 1085.86:1.425, 1112.07:1.794, 1408.01:2.331, 1299.14:0.1887}

am241_endcap = { 59.54:5128 }
am241_38cm = { 59.54:41.24}
...
def correction_factor(source_dict_near,source_dict_far,energy):
    ratio_near = number_counts(am241_endcap,am241_38cm,59.54)[0] / number_counts(source_dict_near,source_dict_far,energy)[0]
    ratio_far = number_counts(am241_endcap,am241_38cm,59.54)[1] / number_counts(source_dict_near,source_dict_far,energy)[1]
    correction_factor = ratio_near/ratio_far
    return correction_factor

correction_factors_list = []
for energy in eu152_endcap.keys():
    correction_factors_list.append(correction_factor(eu152_endcap,eu152_38cm,energy))
